...
**Before:**
   ...
   * [DistributionTask_Organization](DistributionTask_Organization.md): 206 times
...
126 occurrences (example appeal IDs: [40915, 42334, 41269, 42634, 40596])
...
74 occurrences (example appeal IDs: [15152, 42078, 39814, 42497, 40530])
...
6 occurrences (example appeal IDs: [40894, 42805, 42609, 40894, 42805])
